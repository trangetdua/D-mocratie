    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (selectedUser.isPresent()) {
                ...
                System.out.println("2. Maximiser le nombre total de votes satisfaits tout en garantissant les contraintes de budget et de thématiques.");
                ...
                if (choice == 1) {
                    ...
                    List<Proposition> resultMaxVotes = Decision.FBSatisfaction(new ArrayList<>(propositions), 10000, votes);
                    ...
                    System.out.println("3. Recursif (Thematique Popularité)");
                    ...
                    if (choix == 1) {
                        ...
                        System.out.print("Saisir le budget disponible pour les thématiques: ");
                        float budget = scanner.nextFloat();
                        scanner.nextLine();

                        List<Proposition> result = algo.recursifThematiquePopularite(budget, new ArrayList<>(propositions));
                        System.out.println("Résultat de Recursif (Popularité Thématique):");
                        result.forEach(System.out::println);
