	...
	<h1> Mes groupes </h1>
	<?php 
		$curlGroupes = curl_init('https://projets.iut-orsay.fr/saes3-aviau/TestProket/web2/controller/api.php/utilisateur/id_utilisateur/membre/id_groupe/groupe/?method=GET');
		curl_setopt($curlGroupes,CURLOPT_RETURNTRANSFER,1);
		$groupes = json_decode(curl_exec($curlGroupes),true);

		$curlThemes = curl_init('https://projets.iut-orsay.fr/saes3-aviau/TestProket/web2/controller/api.php/groupe/id_groupe/Thème/?method=GET');
