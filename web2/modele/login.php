...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email && $password) {
        $url ="https://projets.iut-orsay.fr/saes3-aviau/TestProket/web2/controller/api.php/utilisateur/?method=GET";
        $curl = curl_init($url);
        ...
        header('Location: ../vue/connection.php?error=invalid');
        exit;

    } else {
        header('Location: ../vue/connection.php?error=missing');
        exit;
    }
